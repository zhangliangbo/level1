...
import com.mcivicm.mathematica.exception.MaxStepException;
import com.mcivicm.mathematica.exception.NoEnoughResultException;
...
import static com.mcivicm.mathematica.Constant.MaxStep;
import static com.mcivicm.mathematica.NestWhileList.nestWhileList;
...
public class NestWhile {
    ...
    public static <T> T nestWhile(Function<T, T> function, T initValue, Predicate<List<T>> test, int m, int maxStep, int extra) throws NoEnoughResultException {
        List<T> list = nestWhileList(function, initValue, test, m, maxStep, extra);
